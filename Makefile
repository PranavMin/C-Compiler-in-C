...
PCC3H	= defs.h types.h bucket.h symtab.h $(BACKEND).h tree.h eval.h myarray.h

PCC3OBJ = main.o message.o symtab.o types.o bucket.o utils.o gram.o scan.o $(BACKEND).o tree.o myarray.o eval.o
...
clean:
	-rm -f pcc3 *.o y.tab.h y.output y.tab.c lex.yy.c T4L* a.out
